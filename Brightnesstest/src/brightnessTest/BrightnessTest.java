...
public class BrightnessTest {
	...
	public static void setHeightOfSlice(){
		...
		for(int sliceIndex1=0; sliceIndex1<star1.slices;sliceIndex1++){
			...
			if(xCoord==0){
				...
				star1Heights[sliceIndex1] = Math.sqrt((star1.radius)*(star1.radius)-Math.pow((star1.radius-(star1.radius*xCoord/star1.hemiSlices)), 2));
			}
		}
		...
		for(int sliceIndex2=0; sliceIndex2<star2.slices;sliceIndex2++){
			...
			if(xCoord==0){
				...
				star2Heights[sliceIndex2] = Math.sqrt((star2.radius)*(star2.radius)-Math.pow((star2.radius-(star2.radius*xCoord/star2.hemiSlices)), 2));
			}
		}
	}
	...
	public static int getEclipseTime(){
		...
		System.out.println(star1.radius);
		System.out.println(star2.radius);
	...
	public static void generateGraph(){
		...
		System.out.println(waitingTime*4-1);
